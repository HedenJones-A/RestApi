...
public class DescController {
    ...
    @GetMapping("/desc/get/{pgno}/{pgsize}/{field}")
    public List<DescModel> getMethodName(@PathVariable int pgno,@PathVariable int pgsize,@PathVariable String field) {
        return descService.get(pgno,pgsize,field);
    }
